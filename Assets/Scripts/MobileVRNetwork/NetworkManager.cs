...
public class NetworkManager : MonoBehaviour, INetworkManager
{
    ...
    public async Task InitialConnectionAsync(NetworkStream stream)
    {
    ...
    public async void AsyncReadingLogic(NetworkStream stream)
    {
    ...
    public async Task ReceiveCommandsAsync(NetworkStream networkStream)
    {
    ...
    public async Task<MessageResponse> ProcessMessage<T>(Message<T> message) 
    {
